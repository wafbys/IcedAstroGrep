...
namespace IcedAstroGrep
{
	...
	public sealed class GeneralSettings
	{
		...
		public static string Location
		{
			get
			{
				return Path.Combine(ApplicationPaths.DataFolder, "IcedAstroGrep.general.config");
			}
		}
		...
		/// <summary>
		/// Gets/sets whether to use the IcedAstroGrep accent color.
		/// </summary>
		public static bool UseIcedAstroGrepAccentColor
		{
			get { return MySettings.useIcedAstroGrepAccentColor; }
			set { MySettings.useIcedAstroGrepAccentColor = value; }
		}
