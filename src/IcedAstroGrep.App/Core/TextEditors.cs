...
namespace IcedAstroGrep
{
   ...
   public class TextEditors
   {
      ...
      {
         string editorsString = IcedAstroGrep.GeneralSettings.TextEditors;
      ...
      public static void Save(TextEditor[] editors)
      {
         if (editors != null)
         {
            ...
            IcedAstroGrep.GeneralSettings.TextEditors = builder.ToString();
         }
         else
         {
            __TextEditors = null;
            IcedAstroGrep.GeneralSettings.TextEditors = string.Empty;
         }
