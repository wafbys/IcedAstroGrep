...
namespace IcedAstroGrep.Windows.Forms
{
   public partial class frmOptions
   {
      ...
      private void InitializeComponent()
      {
			...
			this.btnResultsContextForeColor = new IcedAstroGrep.Windows.Controls.ColorButton();
			...
			this.btnResultsWindowBackColor = new IcedAstroGrep.Windows.Controls.ColorButton();
			this.btnResultsWindowForeColor = new IcedAstroGrep.Windows.Controls.ColorButton();
			...
			this.BackColorButton = new IcedAstroGrep.Windows.Controls.ColorButton();
			this.ForeColorButton = new IcedAstroGrep.Windows.Controls.ColorButton();
      ...
      private IcedAstroGrep.Windows.Controls.ColorButton btnResultsWindowBackColor;
      private IcedAstroGrep.Windows.Controls.ColorButton btnResultsWindowForeColor;
      ...
      private IcedAstroGrep.Windows.Controls.ColorButton BackColorButton;
      private IcedAstroGrep.Windows.Controls.ColorButton ForeColorButton;
