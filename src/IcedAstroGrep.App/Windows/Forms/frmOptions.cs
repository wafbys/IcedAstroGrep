...
namespace IcedAstroGrep.Windows.Forms
{
	...
	public partial class frmOptions : BaseForm
	{
		...
		{
			IcedAstroGrep.Core.EncodingDetection.Caching.EncodingCache.Instance.Clear(true);
		...
		private void btnOK_Click(object sender, System.EventArgs e)
		{
			...
			GeneralSettings.UseIcedAstroGrepAccentColor = chkLabelColor.Checked;
		...
		private void frmOptions_Load(object sender, System.EventArgs e)
		{
			...
			chkLabelColor.Checked = GeneralSettings.UseIcedAstroGrepAccentColor;
			...
			ForceBackColor(tabGeneral, Theme.ThemeProvider.Theme.Colors.Window);
			ForceBackColor(tabFileEncoding, Theme.ThemeProvider.Theme.Colors.Window);
			ForceBackColor(tabTextEditors, Theme.ThemeProvider.Theme.Colors.Window);
			ForceBackColor(tabResults, Theme.ThemeProvider.Theme.Colors.Window);
