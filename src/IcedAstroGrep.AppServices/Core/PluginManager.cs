...
namespace IcedAstroGrep
{
   ...
   public class PluginManager
   {
      ...
      /// Add a plugin to the collection.
      /// </summary>
      /// <param name="plugin">Plugin to add (IIcedAstroGrepPlugin)</param>
      /// <returns>Position of plugin in collection</returns>
      /// <history>
      /// [Curtis_Beard]		07/28/2006	Created
      /// </history>
      public static int Add(IIcedAstroGrepPlugin plugin)
      {
      ...
      public static void Load()
      {
         ...
         string[] plugins = Utils.SplitByString(PluginSettings.Plugins, DELIMETER);
      ...
      public static void Save()
      {
         ...
         PluginSettings.Plugins = plugins.ToString();
         PluginSettings.Save();
      }
      #endregion
            ...
            foreach (Type objType in dll.GetTypes())
            {
               ...
               if (objType.IsPublic)
               {
                  ...
                  if (!((objType.Attributes & TypeAttributes.Abstract) == TypeAttributes.Abstract))
                  {
                     ...
                     objInterface = objType.GetInterface("IcedAstroGrep.Core.Plugin.IIcedAstroGrepPlugin", true);
                     if (objInterface != null)
                     {
                        ...
                        IIcedAstroGrepPlugin plugin = (IIcedAstroGrepPlugin)objPlugin;
