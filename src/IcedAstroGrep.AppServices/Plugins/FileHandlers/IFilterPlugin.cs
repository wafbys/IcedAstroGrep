...
namespace IcedAstroGrep.Plugins.FileHandlers
{
	/// <summary>
	...
	public class FileHandlersPlugin : IIcedAstroGrepPlugin
	{
		...
		/// </summary>
		public string Author => "The IcedAstroGrep Team";
		...
		public bool IsFileSupported(FileInfo file)
		{
			...
			//catch (Exception ex)
			//{
			//	IcedAstroGrep.Core.Logging.LogClient.Instance.Logger.Warn(ex, $"Unknown error trying to detect iFilter for {file.FullName}");
			//}
