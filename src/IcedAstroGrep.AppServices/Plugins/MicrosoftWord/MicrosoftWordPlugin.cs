...
namespace IcedAstroGrep.Plugins.MicrosoftWord
{
	/// <summary>
	...
	/// </history>
	public class MicrosoftWordPlugin : IDisposable, IIcedAstroGrepPlugin
	{
		private const string PLUGIN_AUTHOR = "The IcedAstroGrep Team";
