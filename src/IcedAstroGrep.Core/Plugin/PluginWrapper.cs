namespace IcedAstroGrep.Core.Plugin
{
   /// <summary>
   /// Wrapper class for IIcedAstroGrepPlugins.
   /// </summary>
   /// <remarks>
   ...
   public class PluginWrapper
   {
      ...
      /// Initializes a new instance of the PluginWrapper class.
      /// </summary>
      /// <param name="plugin">IIcedAstroGrepPlugin</param>
      ...
      /// [Curtis_Beard]		07/31/2006	Created
      /// </history>
      public PluginWrapper(IIcedAstroGrepPlugin plugin, string assemblyPath,
      ...
      /// <summary>
      /// Contains the IIcedAstroGrepPlugin.
      /// </summary>
      /// <history>
      /// [Curtis_Beard]		07/31/2006	Created
      /// </history>
      public IIcedAstroGrepPlugin Plugin { get; set; }
