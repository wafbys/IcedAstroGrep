...
using IcedAstroGrep.Windows.Forms;
	...
	public class ColorButton : System.Windows.Forms.Button
	{
		...
		private class ColorPaletteDialog : BaseForm
		{
			...
			public ColorPaletteDialog(Point startingPoint, Color selectedColor)
			{
				...
				this.BackColor = Theme.ThemeProvider.Theme.Colors.Control;
				// form properties
				...
				__otherButton.ForeColor = Theme.ThemeProvider.Theme.Colors.ForeColor;
		...
		/// </summary>
		public override Color BackColor { get => Theme.ThemeProvider.Theme.Colors.Control; }
		...
		private void ButtonPaint(object sender, PaintEventArgs e)
		{
			...
			Pen pen = new Pen(Theme.ThemeProvider.Theme.Colors.ForeColor);
		...
		private void ColorButton_Click(object sender, System.EventArgs e)
		{
			...
			clDlg.ColorChosen += new IcedAstroGrep.Windows.Controls.ColorButton.ColorPaletteDialog.ColorChosenHandler(ColorChosen);
			clDlg.Show();
		}
