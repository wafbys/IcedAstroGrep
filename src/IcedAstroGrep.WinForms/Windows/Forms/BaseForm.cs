	...
	public class BaseForm : Form
	{
		...
		public void LoadTheme(Control ctrl)
		{
			if (ProcessColorChange)
			{
				...
				ctrl.ForeColor = Theme.ThemeProvider.Theme.Colors.ForeColor;
				ctrl.BackColor = Theme.ThemeProvider.Theme.Colors.Control;

				if (ctrl is TextBox || ctrl is ComboBox)
				{
					ctrl.BackColor = Theme.ThemeProvider.Theme.Colors.Window;
				}
				...
				{
					lnk.ActiveLinkColor = Theme.ThemeProvider.Theme.Colors.LinkColor;
					lnk.LinkColor = Theme.ThemeProvider.Theme.Colors.LinkColor;
				}

				// ListView special changes
				if (ctrl is ListView lsv)
				{
					lsv.BackColor = Theme.ThemeProvider.Theme.Colors.Window;
				}
				...
				if (ctrl is Panel pnl)
				{
					...
					{
						pnl.BackColor = Theme.ThemeProvider.Theme.Colors.Window;
					}
				}
