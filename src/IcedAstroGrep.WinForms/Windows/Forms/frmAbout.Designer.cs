namespace IcedAstroGrep.Windows.Forms
{
   public partial class frmAbout
   {
      ...
      private void InitializeComponent()
      {
			...
			this.lblProductName.Text = "IcedAstroGrep";
			// 
			// CopyrightLabel
			// 
			...
			this.lblDescription.Text = "Additional Copyright (C) 2002 to Theodore L. Ward. IcedAstroGrep comes with ABSOLUTEL" +
