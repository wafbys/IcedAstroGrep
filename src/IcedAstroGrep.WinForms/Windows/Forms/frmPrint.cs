	...
	public partial class frmPrint : BaseForm
	{
		...
		private void OutputResults(MatchResultsExport.PrintDelegate outputter)
		{
			...
			foreach (var index in currentResult.HighlightIndexes)
			{
				...
				{
					printRTB.SelectionBackColor = Convertors.ConvertStringToColor(GeneralSettings.HighlightBackColor);
					printRTB.SelectionColor = Convertors.ConvertStringToColor(GeneralSettings.HighlightForeColor);
				}
			}
		}
