      ...
      public int Compare(object x, object y)
      {
         ...
         try
         {
            if (col == Constants.COLUMN_INDEX_COUNT)
            {
               ...
               int firstInt = Convertors.GetHitCountFromCountDisplay(((ListViewItem)x).SubItems[col].Text);
               int secondInt = Convertors.GetHitCountFromCountDisplay(((ListViewItem)y).SubItems[col].Text);
